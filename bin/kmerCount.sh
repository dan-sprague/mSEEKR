#!/bin/bash
python kmers.py --fasta ./fastaFiles/noHumanA.fa -k 2,3,4,5,6,7,8,9 --name A -n 8 --dir ./counts/
python kmers.py --fasta ./fastaFiles/noHumanB.fa -k 2,3,4,5,6,7,8,9 --name B -n 8 --dir ./counts/
python kmers.py --fasta ./fastaFiles/noHumanD.fa -k 2,3,4,5,6,7,8,9 --name D -n 8 --dir ./counts/
python kmers.py --fasta ./fastaFiles/noHumanE.fa -k 2,3,4,5,6,7,8,9 --name E -n 8 --dir ./counts/
python kmers.py --fasta /Users/dan/Documents/Lab/hgTranscriptome/hg26Transcripts.fa -k 2,3,4,5,6,7,8,9 --name hgT -n 8 --dir ./counts/
